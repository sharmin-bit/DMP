  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://127.0.0.1:8000/api/myapp/auth/register/",
        {
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-slate-700/70 bg-slate-900/80 px-8 py-9 shadow-[0_24px_80px_rgba(15,23,42,0.9)] backdrop-blur-3xl">
        ...
        <form onSubmit={handleSignup} className="mt-5 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 via-sky-500 to-fuchsia-500 px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-indigo-500/40 transition hover:brightness-110"
          >
